...
def generate_detections(encoder, mot_dir, output_dir, offset, det_stage='det', detection_dir=None, openpose='', alpha_op=0, lomo_config='', lomo=0):
    ...
    detection_dir
        ...
        MOTChallenge structure: `[sequence]/post-detection/result_detection.txt`. If None, uses the
    ...
    image_dir = os.path.join(sequence_dir, "post-detection")
    image_filenames = {
    ...
    detection_file = os.path.join(
        sequence_dir, "post-detection/result_detection.txt")
...
def parse_args():
    ...
    parser.add_argument(
        ...
        "MOTChallenge structure: [sequence]/post-detection/result_detection.txt", default=None)
    parser.add_argument(
